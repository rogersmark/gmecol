...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserGame.rating'
        db.alter_column('gmecol_usergame', 'rating', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'UserGame.rating'
        db.alter_column('gmecol_usergame', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))
