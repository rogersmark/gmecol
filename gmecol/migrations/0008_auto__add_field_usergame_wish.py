...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserGame.wish'
        db.add_column('gmecol_usergame', 'wish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserGame.wish'
        db.delete_column('gmecol_usergame', 'wish')
    ...
    models = {
        ...
        'gmecol.usergame': {
            ...
            'wish': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'gmecol.userprofile': {
