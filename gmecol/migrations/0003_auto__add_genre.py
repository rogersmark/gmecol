...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('gmecol', ['Genre'])

        # Adding M2M table for field genres on 'Game'
        db.create_table('gmecol_game_genres', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('game', models.ForeignKey(orm['gmecol.game'], null=False)),
            ('genre', models.ForeignKey(orm['gmecol.genre'], null=False))
        ))
        db.create_unique('gmecol_game_genres', ['game_id', 'genre_id'])


    def backwards(self, orm):
        # Deleting model 'Genre'
        db.delete_table('gmecol_genre')

        # Removing M2M table for field genres on 'Game'
        db.delete_table('gmecol_game_genres')
    ...
    models = {
        ...
        'gmecol.game': {
            ...
            'genres': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['gmecol.Genre']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
